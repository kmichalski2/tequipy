...
import { OffbaordData, EmployeesService } from '../../infrastructure/employees.service';
...
export class OffboardDialogComponent {
  constructor(private employeesService: EmployeesService, @Inject(MAT_DIALOG_DATA) private data: OffboardDialogData, private dialogRef: MatDialogRef<OffboardDialogComponent>) {
  }
...
readonly form = new FormGroup({
  ...
  onSubmit($event: SubmitEvent): void {
    ...
    this.employeesService.offboard(this.data.employeeId, data).subscribe(() => {
